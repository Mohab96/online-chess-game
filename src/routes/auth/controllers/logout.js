/* 
  The logout logic is just invalidating the token by adding it to the invalidated tokens list in redis,
  so that the token cannot be used again even it is valid.
*/
